        ...
        <body className=${bodyClasses().join(" ")} {...bodyAttributes()}>
            ...
            <div className="mt-3 md:mt-12 text-center container max-w-screen-lg mx-auto px-4 md:px-8">
                <div className="w-full">
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSehTgzukUDpqONaxwiqWWn-14mDeaBHI4U9qpKbg7njk6IJbA/viewform">
                        <img className="w-full" src=${R("/images/dim6-web-banner.jpg")} alt="埗兵糧食儲備升級團購"/>
                    </a>
                </div>
            </div>
            ...
            <footer className="color_black_o60 py-3">
                <p>
                    Copyright (C) 2020-2022 <a href="https://giffon.io">Giffon Limited</a>
                </p>
                <p>
