        ...
        <body className=${bodyClasses().join(" ")} {...bodyAttributes()}>
            ...
            <div className="mt-3 mt-md-5 text-center container">
                <div className="col-12">
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScyydoYxadEtvrwgUcplDZjxbHMmV-cCFlKtE0wcwJwb3cl_A/viewform"><img className="img-fluid d-inline" src=${R("/images/rice-dump-form.jpg")} alt="KOLB x 點心紙 x 埗兵 端午節團購"/></a>
                </div>
                <div className="col-12 mt-2 color_black_o60">
