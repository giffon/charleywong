                ...
                <div className="container max-w-screen-lg mx-auto sm:px-4 md:flex">
                        ...
                        <div className="w-full md:w-1/2 pr-4 pl-4">
                            ...
                            <div className="text-center lg:px-12 pb-4 md:py-0 color_black_o60">
                                ...
                                <p className="p-6">Charley Wong 和你查 以高度透明同公開嘅方式運作，而且鼓勵同路人使用我地嘅成果：我地以 <a name="open-license" href="https://github.com/giffon/charleywong/blob/master/LICENSE">open license</a> 發佈所有<a name="github" href="https://github.com/giffon/charleywong">數據同原碼</a>。任何人只要註明出處，都可以隨意使用。</p>
                            </div>
                        </div>
            ...
            <div className="mt-5 container max-w-screen-lg mx-auto px-4">
                <div className="md:flex color_black_o60">
                    <div className="md:m-4 mb-3 p-6 md:p-6 lg:p-12 bg-stripe-y rounded-10 text-center relative flex-grow max-w-full flex-1 px-4">
                        ...
                        <div className="text-3xl mt-2"><a className="color_fb" title="Charley on Facebook" name="facebook" href="https://www.facebook.com/charleywong2020"><i className="fab fa-facebook"></i></a>&nbsp;&nbsp;<a className="color_ig"  title="Charley on Instagram" name="instagram" href="https://www.instagram.com/charleywongwong/"><i className="fab fa-instagram"></i></a></div>
                    </div>
