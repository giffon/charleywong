...
class Mooncake2020 extends View {
    static final data:Array<charleywong.browser.Mooncake2020Data> = [
        {
            "name": "拾月中秋．兄弟爬山．香港月餅聯承寄賣計劃",
            "note": "潮食閣等多間黃店",
            "types": [
                "蛋黃蓉白蓮蓉月餅"
            ],
        ...
        {
            "name": "八店聯乘",
            "note": "車麵館, 光榮冰室, 原汁原味, 後街牛扒, 茶半香初, 新景園咖喱小廚, 水門泰式雞飯專門店, 陸陸雞煲火鍋",
            "types": [
                "雙黃白蓮蓉月餅"
            ],
            "current": true,
    ...
    static public final path = "page/mooncake2020";
    ...
    override function bodyClasses():Array<String> {
        return super.bodyClasses().concat([
            "page-mooncake2020"
        ]);
    }
