                ...
                <div className="mt-5 container">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-12 col-md-6 col-lg-4 order-first-lg">
                            <div>
                                <img className="w-100 p-3" src="/images/circle.png"/>
                            </div>
                        ...
                        <div className="col-12 col-md-6 col-lg-4">
                            <div>
                                <img className="w-100 p-3" src="/images/open.png"/>
                            </div>
                            <div className="text-center px-5 color_black_o60">
                                ...
                                <p className="p-3">Charley Wong 和你查 以高度透明同公開嘅方式運作，而且鼓勵同路人使用我地嘅成果：我地以 open license 發佈所有數據同原碼。任何人只要註明出處，都可以隨意使用。</p>
                            </div>
                        </div>
                    </div>
                </div>
